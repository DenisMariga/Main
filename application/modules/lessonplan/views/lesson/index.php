                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php foreach($lesson_list AS $ld){ ?>
                                                        <?php echo $ld->Ltitle; ?><br/>
                                                <?php } } ?>
                                            
                                            </td>
                                            <td>                                                      
                                                <?php if(has_permission(EDIT, 'lessonplan', 'lesson')){ ?>
                                                    <a href="<?php echo site_url('lessonplan/lesson/edit/'.$obj->id); ?>" Ltitle="<?php echo $this->lang->line('edit'); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                <?php } ?> 

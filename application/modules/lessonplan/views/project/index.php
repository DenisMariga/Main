...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">  
   ...
   <?php if(isset($project) && !empty($project)){ ?>
        get_class_by_school('<?php echo $project->school_id; ?>', '<?php echo $project->class_id; ?>', 'edit_');
    <?php } ?>    
   ...
   <?php if(isset($project)){?>
        get_lesson_by_subject('<?php echo $project->subject_id; ?>', '<?php echo $project->lesson_detail_id; ?>', 'edit_');
    <?php } ?>    
...
<?php if(isset($project)){?>
        get_topic_by_lesson('<?php echo $project->lesson_detail_id; ?>', '<?php echo $project->topic_details_id; ?>', 'edit_');
    <?php } ?>   

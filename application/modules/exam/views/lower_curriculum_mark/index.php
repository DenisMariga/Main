<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-file-text-o"></i><small> <?php echo $this->lang->line('manage_lower_mark'); ?></small></h3>
            ...
            <div class="x_content"> 
                <?php echo form_open_multipart(site_url('exam/lowercurriculummark/index'), array('name' => 'mark', 'id' => 'mark', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">
           ...
           <?php  if (isset($students) && !empty($students)) { ?>
            ...
            <div class="x_content">
                 <?php echo form_open(site_url('exam/lowercurriculummark/add'), array('name' => 'addmark', 'id' => 'addmark', 'class'=>'form-horizontal form-label-left'), ''); ?>
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th colspan="2" style="text-align: center;"><?php echo $this->lang->line('mark'); ?></th>
                                                                                       
                            <th colspan="1" style="text-align: center;"><?php echo $this->lang->line('total'); ?></th>                                            
                                                                  
                        </tr>
                        <tr>                           
                            <th><?php echo $this->lang->line('mark'); ?></th>                                            
                            <th><?php echo $this->lang->line('obtain'); ?></th>                                                                                        
                            <th style="text-align: center;"><?php echo $this->lang->line('eighty'); ?>                                      
                    ...
                    <tbody id="fn_mark">   
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $mark = get_lower_curriculum_mark($school_id, $obj->student_id, $academic_year_id, $exam_id, $class_id, $section_id, $subject_id); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!empty($attendance)){ ?>
                                            <input type="number"  id="obtain_<?php echo $obj->student_id; ?>"  itemid="<?php echo $obj->student_id; ?>"  value="<?php if(!empty($mark) && $mark->obtain > 0 ){ echo $mark->obtain; }else{ echo ''; } ?>"  name="obtain[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12 fn_mark_total"   autocomplete="off"/>
                                        <?php }else{ ?>
                                            <input readonly="readonly" type="number" value="0"  name="obtain[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12" />
                                        <?php } ?>
                                    </td>                              
                                    <td>
                                        <input readonly="readonly" type="number"  id="lower_exam_total_mark_<?php echo $obj->student_id; ?>" value="<?php if(!empty($mark) && $mark->lower_exam_total_mark > 0){ echo $mark->lower_exam_total_mark; }else{ echo '';} ?>"  name="lower_exam_total_mark[<?php echo $obj->student_id; ?>]" class="form-control form-mark col-md-7 col-xs-12"  autocomplete="off" />
                                    </td>
...
<!-- Super admin js end -->
 ...
 <script type="text/javascript">     
  ...
  $('.fn_mark_total').keyup(function(){         
    ...
    var obtain = $('#obtain_'+student_id).val() ? parseFloat($('#obtain_'+student_id).val()) : 0;
    
    if (obtain > exam_mark) {
      alert('Obtain mark cannot be greater than exam mark!');
      $('#obtain_'+student_id).val('');
      $('#lower_exam_total_mark_'+student_id).val('');
      return;
    }
    
    $('#lower_exam_total_mark_'+student_id).val(Math.round((obtain / exam_mark) * 80));

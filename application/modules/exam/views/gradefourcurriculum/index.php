<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content"> 
                <?php echo form_open_multipart(site_url('exam/gradefourcurriculum/index'), array('name' => 'mark', 'id' => 'mark', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">
           ...
           <?php  if (isset($students) && !empty($students)) { ?>
            ...
            <div class="x_content">
                 <?php echo form_open(site_url('exam/gradefourcurriculum/add'), array('name' => 'addmark', 'id' => 'addmark', 'class'=>'form-horizontal form-label-left'), ''); ?>

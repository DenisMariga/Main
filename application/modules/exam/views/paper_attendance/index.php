<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-graduation-cap"></i><small> <?php echo $this->lang->line('manage_paper_attendance'); ?></small></h3>
          ...
          <div class="x_content quick-link">
            ...
            <div class="x_content"> 
                <?php echo form_open_multipart(site_url('exam/paperattendance/index'), array('name' => 'student', 'id' => 'student', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_attendance">   
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php $attendance = get_student_paper($school_id, $obj->student_id, $academic_year_id, $exam_id, $class_id, $section_id, $subject_id,$paper_id); ?>
                                <tr>
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function(){
       ...
       $('.fn_single_attendnce').click(function(){
          ...
          $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('exam/paperattendance/update_single'); ?>",
            data   : {school_id:school_id, status : status , exam_id:exam_id, student_id: student_id, class_id:class_id, section_id:section_id, subject_id:subject_id,paper_id:paper_id},               
            async  : false,
            success: function(response){ 
                if(response == 'ay'){
         ...
         $('.fn_all_attendnce').click(function(){
          ...
          $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('exam/paperattendance/update_all'); ?>",
            data   : {school_id:school_id, status : status , exam_id:exam_id, class_id:class_id, section_id:section_id, subject_id:subject_id, paper_id:paper_id},               
            async  : false,
            success: function(response){

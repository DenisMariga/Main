    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content no-print"> 
                <?php echo form_open_multipart(site_url('exam/gradefourresult/index'), array('name' => 'marksheet', 'id' => 'marksheet', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row"> 
...
<!-- <div class="col-sm-6 col-xs-6 col-sm-offset-3 col-xs-offset-3 layout-box">
    <p>
        ...
        if ($sum <= 32) {
            ...
            // Check additional conditions for Division 4
            $hasD1D2 = false;
            $hasP7 = 0;
            $hasD1D2C3C4C5C6 = 0;
            ...
            foreach ($subjects as $obj) {
                ...
                if (in_array($obj->grade_name, ['P7'])) {
                    $hasP7++;
                }
                if (in_array($obj->grade_name, ['D1', 'D2', 'C3', 'C4', 'C5', 'C6', 'P7'])) {
                    $hasD1D2C3C4C5C6++;
                }
            }
        ...
        <strong>Rank:</strong> <?php echo $rank; ?>
    </p>
</div> -->
<div class="col-sm-6 col-xs-6 col-sm-offset-3 col-xs-offset-3 layout-box">
    <p>
                        ...
                        if (isset($subjects) && !empty($subjects)) {
                            ...
                            <?php foreach ($subjects as $obj) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $obj->average_point; ?></td>

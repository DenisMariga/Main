...
class Alevelresult extends MY_Controller {

    public $data = array();

    function __construct() {
        parent::__construct();
        $this->load->model('Alevelresult_Model', 'mark', true);
    ...
    * ********************************************************** */
    public function index() {
        ...
        if ($_POST) {
            ...
            $this->data['papers'] = $this->mark->get_paper_list($school_id, $class_id, @$school->academic_year_id); 
